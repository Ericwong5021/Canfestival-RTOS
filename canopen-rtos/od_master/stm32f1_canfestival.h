...
typedef struct
{
	unsigned short cmd;      //0x0000 Í¨ÓÃÖ¸Áî 0x0100 µç»úAÖáÖ¸Áî£¬0x0200 µç»úBÖáÖ¸Áî
	unsigned short RunStatus;
	unsigned long ErrCode;
	unsigned short RunMode;
	unsigned short Meteri_Null;
	unsigned short StepLen;               //µ÷·ùË¿¸Ëµ¼³Ì
	unsigned short AxisEn;           //°´Î»¿ØÖÆÖáÊ¹ÄÜ£¬bit0±íÊ¾0Öá£¬bit1±íÊ¾1Öá
	unsigned short DigtalOut;
	unsigned short DigtalIn;
	unsigned short OutMode;
	unsigned short BackDefVal;
	unsigned long TimeOut;            //ÇóÎïÁÏ³¬Ê±±¨¾¯
